...
// ----------------------------------------------------------------------
// ** MARCADORES ESTÁTICOS E REGIÃO INICIAL **
// ----------------------------------------------------------------------
const STATIC_MARKERS = [
  {
    id: 1,
    title: "Ponto Inicial (Home)",
    description: "Coordenada: -9.9707 / -67.8404",
    coordinate: { latitude: -9.970756929157032, longitude: -67.84043066203594 },
    pinColor: "blue",
  },
  {
    id: 2,
    title: "Segundo Ponto de Interesse",
    description: "Um ponto próximo em Rio Branco",
    coordinate: { latitude: -9.978, longitude: -67.809 },
    pinColor: "red",
  },
];

const INITIAL_MAP_REGION = {
  latitude: -9.97435, // Centro Lat
  longitude: -67.8247, // Centro Lng
  latitudeDelta: 0.02, // Zoom que engloba os dois pontos
  longitudeDelta: 0.04, // Zoom que engloba os dois pontos
};
// ----------------------------------------------------------------------
...
export default function Home() {
  ...
  const [expanded, setExpanded] = useState(false); // Mantido apenas para controle de UI
  ...
  async function carregarEventos() {
    try {
      ...
      // Normalização mantida para consistência de dados
  ...
  const handleLimparFiltros = () => {
    setSearchText("");
    setEventosFiltrados(eventos); // Retorna à lista completa
  };
      ...
      {!expanded ? (
        <View style={styles.mapaCard}>
          <MapView
            ...
            initialRegion={INITIAL_MAP_REGION} // Define a área de visualização inicial
          >
            {/* INSERINDO OS 2 MARCADORES ESTÁTICOS */}
        ...
        <View style={styles.mapaFull}>
          <MapView
            ...
            initialRegion={INITIAL_MAP_REGION} // Define a área de visualização inicial
          >
            {/* INSERINDO OS 2 MARCADORES ESTÁTICOS no modo expandido */}
            {STATIC_MARKERS.map((marker) => (
              <Marker
                key={marker.id}
                coordinate={marker.coordinate}
